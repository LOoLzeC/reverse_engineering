...
# # # # # # # # # # # # # # # # # # # # # # # #
#         Decompyle by Deray Feat Ahmad Riswanto         #
# # # # # # # # # # # # # # # # # # # # # # # #  
...
def menu():
    ...
    print 40 * '\x1b[1;97m='
    print '\x1b[1;91m1.\x1b[1;97m Informasi akun teman || \x1b[1;91m6.\x1b[1;97m Periksa update'
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            ...
                            if zedd == '6':
                                ...
                                if 'v1.6' in str(r) or 'v1.7' in str(r) or 'v1.8' in str(r) or 'v1.9' in str(r) or 'v2.0' in str(r) or 'v2.1' in str(r):
                                    os.system('reset')
                                    os.system('cd;rm -rf dark-fb')
                                    jalan('\x1b[1;91m[!] \x1b[1;92mClonning ulang \x1b[1;97m...')
                                    os.system('cd;git clone https://github.com/rezadkim/dark-fb')
